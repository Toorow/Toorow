...
description: Security rules, privacy guarantees, zero-telemetry pledges, pre-live checklists, and non-negotiable architectural invariants that govern toorow.
---
