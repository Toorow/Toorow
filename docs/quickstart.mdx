---
title: Quickstart
description: Install and run toorow locally with uv, pnpm, and optional Docker infrastructure for the MCP server, UI, and connector development loop.
---
...
```bash
git clone <repository-url> toorow
cd toorow
