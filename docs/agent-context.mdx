...
### Example Capability Descriptor Response
...
```json
{
  ...
  "supported_grains": ["daily"],
  "fields": [
    {
      "field_id": "activeUsers",
      "canonical_target": "users",
      "type": "integer",
      "hint": "traffic"
    },
    {
      "field_id": "conversions",
      "canonical_target": "conversions",
      "type": "integer",
      "hint": "conversion"
    },
    {
      "field_id": "purchaseRevenue",
...
<Important>
**Non-causal by design**: Context events are presented strictly as **candidate context**, never as definitive causal statements. Agents must avoid language asserting absolute cause (`"caused by"`, `"due to"`).
</Important>
