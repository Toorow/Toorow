...
description: Complete FastMCP tool reference for toorow AI agents, including tool names, parameter schemas, return envelopes, and governed data access patterns.
---
