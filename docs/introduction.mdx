---
title: Introduction to toorow
description: Discover toorow, the sovereign MCP control plane that delivers trustworthy, governed marketing analytics with agent-native tooling and data lineage.
---
