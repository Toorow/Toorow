...
- **Extensible Connector Architecture**: Connectors are self-contained and auto-discovered at boot, featuring manifests, staging SQL, dbt marts, and golden-pull conformance tests.
