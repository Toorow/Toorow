...
description: Production deployment layout for toorow on Google Cloud Platform, using Cloud Run scale-to-zero services, BigQuery, and Firebase Hosting for the UI.
---
