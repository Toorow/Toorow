...
Every ingestion cycle generates a unique, lexically monotonic ULID `pull_id`. Pulls are **immutable and append-only**:
...
<CardGroup cols={2}>
  ...
  <Card title="Adding a Connector" icon="plug" href="/adding-a-connector">
    Build a custom connector for your proprietary data sources.
  </Card>
