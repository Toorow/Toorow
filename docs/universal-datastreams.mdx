...
description: Architecture and workflows for toorow ingestion pipelines across API connectors, external BigQuery objects, and managed CSV and Google Sheets feeds.
---
