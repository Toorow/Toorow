...
def _insert_raw_rows(
    ...
    """Insert canonical rows into raw_square_payments (DuckDB or BigQuery per TOOROW_DB_MODE).
...
def _insert_catalog_rows(rows: list[dict], pull_id: str, loaded_at: str, project_id: str, db_mode: str, duckdb_path: str) -> int:  # noqa: E501
    """Land projected rows into raw_square_catalog_daily (DuckDB and BigQuery)."""
