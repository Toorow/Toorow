/**
 * Déduplication card entrypoint (AD-11). Miroir de ui/cards/attribution/src/main.tsx
 * (Story 9.10 : shared SDK-first reader depuis @toorow/card-shell,
 * canaux legacy conservés en fallback — G-11 origin validation préservée).
 */
...
if (injected) {
  ...
  root.render(
    <React.StrictMode>
      <NoEnvelope title="Deduplication" />
    </React.StrictMode>,
  );
}
